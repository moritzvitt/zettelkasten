...
The German originals remain the source of truth. Each translation records its original note in `translationOf` and `originalPath`.
...
- "Zettel" is kept as "note" in running text unless the zettelkasten structure itself matters.
- "Sprachgefühl" is translated as "language intuition" or "feel for the language" depending on context.
- "fruchtbare Zone" is translated as "fertile zone" for now.
- "Lernlisten" is translated as "learning lists" for now.
