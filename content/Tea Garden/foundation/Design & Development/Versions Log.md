---
title: "Versions Log"
source: "Digital Garden/Tea Garden/foundation/Design & Development/Versions Log.md"
publish: true
tags:
  - zettel
---
...
etwas hellere Schriftart, damit es "handschriftlicher aussieht"
![[Pasted image 20260628191534.png|329]]

Was wäre wenn man das mit "ink bleeding" oder "ink splatter" Effekten verknüpft?

Vielleicht wäre eine selbsgemachte aber "seriöse" Schrift der richtige Weg? Dann würde man es leserlicher halten, aber gleichzeitig hätte es so einen "Notizen" Effekt.
...
Using my own, handwritten font for the text body. Looks actually nice.
Maybe I should try a thinner font for the default font?
![[Pasted image 20260628150120.png|267]]That looks like newspaper snippets, but more cryptic. Kind of mysterious.

![[Pasted image 20260628144045.png]]
that reveals the easter egg with the trees (Combining a note taking like drawing style, with "cyber"-neon-glow, with "Garden" (because it's trees)):
![[Pasted image 20260628144220.png|349]]

I mean: it's supposed to be a digital garden. What's more "cyber" than neon glow?
How can I connect this even more with the Garden theme?
And with note taking?
![[Pasted image 20260628141023.png]]Hover over the teapot makes it glow a little and pop up:

![[Pasted image 20260628140724.png|392]]
...
![[Pasted image 20260628135803.png|309]]
![[Pasted image 20260628130939.png|345]]with Neon Glow:
![[Pasted image 20260628140449.png|345]]
...
Graph view with ink bleeding.
Thin frame. Serif Font (newspaper style).
What I like about this, is that the graph view itself is a very "modern" obsidian feature, but the design makes it look like drops of Ink on a paper, which seems super old-fashioned (I could actually make them a deep blue (maybe like the default html link color) and make them look more "blurred"

![[Pasted image 20260622130748.png|162]]
